...
def test_sorting_order():
    files = [
        ...
        NumberedFile("1. less important.md"),
...
def test_chapters_method(tmp_path: Path):
    ...
    (tmp_path / "2. less important.md").touch()
    ...
    assert result.files[2].new_name == "2. less important.md"
    assert result.files[3].new_name == "3. another.md"
...
def test_appendices_method(tmp_path: Path):
    ...
    (tmp_path / "A3.! appendixn.md").touch()
    ...
    assert result.files[1].new_name == "A2. appendixn.md"
    assert result.files[2].new_name == "A3. appendix2.md"
    assert result.files[3].new_name == "A4. appendix3.md"
